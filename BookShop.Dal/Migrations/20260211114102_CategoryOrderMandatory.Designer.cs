...
namespace BookShop.Dal.Migrations
{
    ...
    [Migration("20260211114102_CategoryOrderMandatory")]
    partial class CategoryOrderMandatory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShop.Dal.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            City = "Budapest",
                            Street = "Magyar Tudósok krt. 2. Q. épület",
                            ZipCode = "1111"
                        },
                        new
                        {
                            Id = 2,
                            City = "Budapest",
                            Street = "Magyar Tudósok krt. 2. I. épület",
                            ZipCode = "1111"
                        });
                });

            modelBuilder.Entity("BookShop.Dal.Entities.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5610e8cb-6f66-4e89-ba44-3287259857a5",
                            DisplayName = "Admin Aladár",
                            Email = "admin@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN@EXAMPLE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEN+jQMxxcf6j/Qh5W23vp91R/ehaCa1xXEEqJuyAyHJvnRxOpK1COKRG/Tb0CdQCxg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5610e8cb-6f66-4e89-ba44-3287259857a5",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5610e8cb-6f66-4e89-ba44-3287259857a5",
                            DisplayName = "Felhasználó Ferenc",
            ...
            modelBuilder.Entity("BookShop.Dal.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2026, 1, 2, 12, 22, 10, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            Text = "Első komment a könyvhöz.",
                            Type = "Comment",
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            BookId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2026, 1, 2, 16, 10, 3, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            Text = "Második komment a könyvhöz.",
                            Type = "Comment",
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            BookId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2026, 1, 3, 8, 47, 24, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            Text = "Első review a könyvhöz.",
                            Type = "Review",
                            UserId = 1
                        },
                        new
                        {
                            Id = 4,
                            BookId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2026, 1, 3, 17, 33, 54, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            Text = "Második review a könyvhöz.",
                            Type = "Review",
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("BookShop.Dal.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BookShop.Dal.Entities.ApplicationUser", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BookShop.Dal.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
